...
![Static Badge](https://img.shields.io/badge/license-MIT-white?style=flat-square)
...
```bash
# Download the file
git clone https://github.com/yourusername/vulnlabs.git
cd vulnlabs
...
### Option 2 — Serve via Python (Recommended for full functionality)
...
### Option 4 — Serve via Node.js (npx)
...
If this helped you learn something, drop a ⭐ — it helps others find it!
